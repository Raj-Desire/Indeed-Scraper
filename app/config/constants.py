...
# Common target countries list for UI dropdown selection, prioritized by Indeed daily job posting volume
COMMON_COUNTRIES: tuple[Country, ...] = (
    # --- Top Priority & High Volume Indeed Markets ---
    ...
    # --- Additional Active European & Global Markets ---
